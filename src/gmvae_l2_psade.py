...
# ============================================================
# CONFIG-"ALM", "BMD", "BFP", "Age", , "ALM", "BMD", "BFP"
# ============================================================
...
RESULTS_ROOT = "GMVAE_PGNN_JUL15_Age"
...
def train_pgnn_for_target(Z_train, y_train_1d, Z_val, y_val_1d, scaler_y, target_idx, target_name, out_dir):
    ...
    total_model_runs = len(KNN_LIST) * sum(
...
def build_kfold_average_tables(dataset_name, folds_df, dataset_out_dir):
    config_cols = ["dataset", "target", "target_idx", "kNN_graph", "K", "p"]
    metric_cols = [
...
def run_one_dataset(csv_path):
    ...
    avg_df, best_avg_df = build_kfold_average_tables(dataset_name, folds_df, dataset_out_dir)
