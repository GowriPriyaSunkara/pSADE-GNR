...
RESULTS_ROOT = "PGNN_RESULTS_VAE_L2_WEIGHTS"
...
def load_penn_for_target(csv_path: str,
    ...
    idx_train, idx_val = train_test_split(idx, train_size=train_size, random_state=seed)
...
def sweep_high_p(csv_path: str):
    ...
    for knn_k in KNN_LIST:
        for target in TARGETS:
            ...
            if USE_VAE:
                cache_key = (csv_path, target, TRAIN_SIZE, SEED,
